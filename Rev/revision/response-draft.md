...
- We expand the Methodology to explain survey-wave pooling, model inputs and validation, gain-based feature importance, cross-layer prediction, and the calculation and interpretation of model-estimated total, direct, and indirect effects.
- We strengthen the Limitations and Future Work section by clarifying the implications of the observational design, unobserved confounding, model fit and common support, the limits of predictive validation, and the potential propagation of uncertainty across analytical layers.
- We reorganize the Results to emphasize the main findings, move selected detailed numerical comparisons to the Supplementary Materials, and add effect-summary and subgroup-inference tables.
- We streamline the Discussion, clarify the theoretical interpretation of the multi-layered framework, and provide more specific policy implications and implementation responsibilities.
