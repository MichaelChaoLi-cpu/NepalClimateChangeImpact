...
**Response:**
Thank you for this important comment. We have revised the Basic Logic of Effect Estimation subsection and the Limitations and Future Work section to clarify how the counterfactual predictions are generated, the assumptions underlying their interpretation, and the limitations arising from the repeated cross-sectional observational data. The revised text distinguishes model-estimated effects under the learned prediction function from experimentally identified causal effects and acknowledges the potential influence of unobserved confounding and measurement error.
